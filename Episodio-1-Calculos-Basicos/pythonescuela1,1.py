...
turistas_en_un_coche = turistas_que_caven_en_solo_un_coche + (turistas_que_caven_en_solo_un_coche%1) 
...
print("En un coche maximo caven", (turistas_en_un_coche), "personas en un coche")

#Anuncio
print()
print()
print("No olvides de subscribir y darle like al video!")
print('Canal De Youtube:')
